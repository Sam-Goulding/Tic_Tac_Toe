...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = ((document.getElementById("letter").classList.contains("valid")) && 
    				 ...
    				 (document.getElementById("match").classList.contains("valid"))); // TODO: Replace false with the correct condition
    if(condition) {       
